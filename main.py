...
locations = {
    "Sungai": Location("Sungai", [
        ...
        Fish("Gurame", "rare", "Sungai"),
        Fish("Nila", "common", "Sungai"),
        Fish("Salmon", "rare", "Sungai"),
        Fish("Arwana", "legendary", "Sungai"),
    ]),
    "Danau": Location("Danau", [
        Fish("Ikan Mujair", "common", "Danau"),
        Fish("Nila", "common", "Danau"),
        Fish("Gurame", "rare", "Danau"),
        Fish("Bawal", "rare", "Danau"),
        Fish("Lele", "common", "Danau"),
        Fish("Salmon", "rare", "Danau"),
    ...
    "Laut": Location("Laut", [
        ...
        Fish("Paus", "legendary", "Laut"),
        Fish("Hiu", "rare", "Laut"),
        Fish("Barakuda", "rare", "Laut"),
        Fish("Marlin", "legendary", "Laut"),
    ]),
}
